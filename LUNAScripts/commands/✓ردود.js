...
module.exports.handleEvent = async function({ api, event, args, Threads, Users }) {
  ...
  var tl4 = ["☹️مطوري لعزيز كيفك","🥺توحشتك يمحمد وين غبرت عود تاني","🇦🇱🇩🇿🇵🇸لحوما ياخو〘━❪𝐃𝐄𝐕𝐄𝐋𝐎𝐏𝐄𝐑 𝐎𝐅 𝐋𝐔𝐍𝐀 𝐁𝐎𝐓❫━〙"];
  ...
  var rand4 = tl4[Math.floor(Math.random() * tl4.length)];
    ...
    if ((event.body.toLowerCase() == "❤️") || (event.body.toLowerCase() == "💗")) {
     ...
     return api.sendMessage("هل انا حبيبتك لترسل لي هذا ؟ (Y) ", threadID, messageID);
...

  {
    ...
    else if (event.senderID == 100044725279836 && (event.body.indexOf("بنتي") == 0 || (event.body.indexOf("بوت") == 0)))
